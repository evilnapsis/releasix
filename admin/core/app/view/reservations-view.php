...
<a href="./index.php?view=newreservation" class="btn btn-default pull-right">Nuevo Evento</a>
			...
			foreach($users as $user){
				...
				$("#btn-<?php echo $user->id;?>").click(function(){
					...
					if(x<?php echo $user->id; ?>){
						window.location = "index.php?action=delreservation&id=<?php echo $user->id; ?>";
					}
