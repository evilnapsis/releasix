<?php 
$reservation = FileData::getById($_GET["id"]);
...
<div class="row">
	...
	<br>
<form class="form-horizontal" role="form" method="post" action="./?action=updatefile">
...
<option value="">-- SELECCIONE --</option>
  ...
  <div class="form-group">
    ...
    <input type="hidden" name="id" value="<?php echo $reservation->id; ?>">
      <button type="submit" class="btn btn-default">Actualizar Archivo</button>
    </div>
  </div>
</form>
